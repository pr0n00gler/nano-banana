<template>
    <button
        ...
        :disabled="disabled"
        :class="[
            'w-full px-8 py-4 rounded-lg font-bold text-white text-lg transition-all duration-200 flex items-center justify-center gap-3 border-4 border-black shadow-lg',
            disabled
